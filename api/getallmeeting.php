<?php
    ...
    if(isset($_GET['Type'])){
        ...
        CURLOPT_URL => "https://api.zoom.us/v2/users/jasu@ytel.co.in/meetings?page_number=1&page_size=30&type=scheduled",
    ...
    function getAutorizationCode($request)
    {
        ...
        $authentication = base64_encode("2xoQ9NcSt2gk3E9xSbyog:4m6d7LFtfvMFsClj4OXCJjgc8VK8SpI1");
